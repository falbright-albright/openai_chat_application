...
export class UserSQLResource implements IDatabaseResource<
  DBUser,
  DBCreateUser
> {
  pool: Pool;
...
export class ChatSQLResource implements IDatabaseResource<
  DBChat,
  DBCreateChat
> {
  pool: Pool;
...
export class MessageSQLResource implements IDatabaseResource<
  DBMessage,
  DBCreateMessage
> {
  pool: Pool;
